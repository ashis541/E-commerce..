                            ...
                            <div class="card product-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="Cartservlet" method="post">
                                        ...
                                        <button class="btn btn-outline-success"> &#8377;<%=products.getpPrice() %>/-<span class="text-secondary discount-label">  &#8377; <%=products.getpPrice() %>  <%=products.getpDiscount() %>% Off</span></button>
                                    </div>   
                                    </form>
