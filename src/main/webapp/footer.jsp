        ...
        <div class="row">
          ...
          <div class="col-xs-6 col-md-3">
            ...
            <ul class="footer-links">
              <li><a href="Home.jsp">Pattachitra</a></li>
              <li><a href="Home.jsp">Tarakasi</a></li>
              <li><a href="Home.jsp">Dokra</a></li>
              <li><a href="Home.jsp">Saree</a></li>
              <li><a href="Home.jsp">Paper Mache</a></li>
              <li><a href="Home.jsp">Handcraft</a></li>
            </ul>
          </div>
      ...
      <div class="container-fluid copy ">
        <div class="row">
          <div class="col-md-8 col-sm-6 col-xs-12">
            <p class="copyright-text py-3">Copyright &copy; 2022 All Rights Reserved by 
         <a href="#">Dadytees</a>.
            </p>
          </div>
